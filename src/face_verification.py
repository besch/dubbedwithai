...
import time
import json
from utils import extract_subtitles_from_srt, copy_dir, subtitle_to_ms, FACES_DIR, CATEGORIZED_DIR, ORIGINAL_VIDEO, SUBTITLES, FRAMES_DIR, FACE_VERIFICATION, FACES_DIR_TEMP

DOMAIN: str = 'http://localhost'
PORT: str = '8000'
API_KEY_RECOGNITION: str = '00000000-0000-0000-0000-000000000002'
API_KEY_DETECTION: str = '00000000-0000-0000-0000-000000000004'
API_KEY_VERIFICATION: str = '00000000-0000-0000-0000-000000000003'
...
def detect_face(input, box) -> bool:
    ...
    output_temp = os.path.join(FACES_DIR_TEMP, 'img.jpg')
    cv2.imwrite(output_temp, face_image)
    
    result = detection.detect(output_temp)
...
def categorize_faces(FACES_DIR, FACES_COPY_DIR, CATEGORIZED_FACES_DIR):
    copy_dir(FACES_DIR, FACES_COPY_DIR)
    
    faces_dir = os.listdir(FACES_COPY_DIR)
    for face in faces_dir[:]:  # Create a copy of the list
        face_path = os.path.join(FACES_DIR, face)
        matched_face_dir = None
        max_similarity = 0

        for existing_face_dir in os.listdir(CATEGORIZED_FACES_DIR):
            existing_face_path = os.path.join(CATEGORIZED_FACES_DIR, existing_face_dir, os.listdir(os.path.join(CATEGORIZED_FACES_DIR, existing_face_dir))[0])
        ...
        if max_similarity > 0.7:
            ...
            new_dir = os.path.join(CATEGORIZED_FACES_DIR, face.split('.')[0])
